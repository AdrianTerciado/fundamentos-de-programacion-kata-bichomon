...
let imagenes = document.querySelectorAll("img");
 ...
 /** 7. Cambia el fondo de todos los infocard-lg-data  para todos los Pokimon voladores  flying */

 /* let document.querySelectorAll(".infocard-lg-data .text-muted > .itype flying") = blue;*/
